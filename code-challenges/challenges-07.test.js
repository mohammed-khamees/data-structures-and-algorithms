...
const addQuestion = (arr) => {
  // Solution code here...
  let questions = arr.map((question) => `${question}?`);
  return questions;
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let index = 0; index < arr.length; index++) {
    powerToTwo.push(Math.pow(2, arr[index]));
  }
  return powerToTwo;
};
...
const forEachTwoToThe = (arr) => {
  ...
  let powerToTwo = [];
  arr.forEach((num) => {
    powerToTwo.push(Math.pow(2, num));
  });
  return powerToTwo;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let powerToTwo = arr.map((num) => Math.pow(2, num));
  return powerToTwo;
};
...
const charCode = (arr) => {
  // Solution code here...
  let newArr = arr.map((el) => el.charCodeAt());
  return newArr;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let abilities = arr.map((el) => el.ability.name);
  return abilities;
};
